...
@testset "θ-functions" begin
    ...
    th_ma = [ 
        0.46214180304899833678 + 0.65513824162092381551im,
    ...
    @test my_isapprox(th[:, 0], th_ma, atol=tol_check)

    #####

    d1_th_ma = [ 
        0.97727706225681589769 + 0.08049915546539055744im,
    ...
    @test my_isapprox(th[:, 1], d1_th_ma, atol=tol_check)

    #####

    d2_th_ma = [
        -0.54549882845031761232 - 0.68893198268462155795im,
    ...
    @test my_isapprox(th[:, 2], d2_th_ma, atol=tol_check)

    #####

    d3_th_ma = [
        -1.05294508933080125267 + 0.15318331373277377347im,
    ...
    @test my_isapprox(th[:, 3], d3_th_ma, atol=tol_check)

    #####

    d4_th_ma = [
        1.2954660922120757234 + 0.9931820896285708616im,
    ...
    @test my_isapprox(th[:, 4], d4_th_ma, atol=tol_check)
